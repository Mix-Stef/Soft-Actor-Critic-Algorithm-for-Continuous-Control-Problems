...
* Value Network Loss: $\displaystyle J_{V}(\psi) = \mathbb{E}_{s_{t} \tilda D}[\frac{1}{2}(V_{\psi}(s_{t}) \mathbb{E}_{a_{t} \tilda \pi_{\phi}}[Q_{\theta}(s_{t}, a_{t}) - \log \pi_{\phi}(a_{t}) | s_{t}]) ^ 2] ]$
